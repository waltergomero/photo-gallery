...
const UserEditForm = ({user}:any) => {
    ...
    const [state, setState] = useState<UserEditFormState | null>(null);
        ...
        <div className="card-body">
            <form className="row g-3" onSubmit={onSubmit}>
                ...
                <div className="col-md-6">
                    ...
                    <span className='text-white bg-primary'>Note: Leave password blank to keep current password</span>
                </div>
                <div className="col-md-12">
                    <CheckboxDefault  title="Is admin?" name="isadmin" checked={user?.isadmin} />
                </div>
                 <div className="col-md-12">
                    <CheckboxDefault  title="Is active?" name="isactive" checked={user?.isactive}/>
                </div>
